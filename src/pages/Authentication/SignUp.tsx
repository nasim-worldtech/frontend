...
import { SignUpInputs } from '../../types/types.adminPanel';
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full rounded-lg border  bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none  dark:bg-form-input dark:text-white dark:focus:border-primary ${
                        errors.name ? 'border-red-500' :  "border-stroke dark:border-form-strokedark"
                      }`}
                    />
                  </div>
                  {errors.name && 
                  <div className='flex items-center gap-1 mt-1'>
                      ...
                      <p className="text-red-500">Name is required</p></div>
                  }
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input
                      ...
                      {...register('confirmPassword', {
                       ...
                       className={`w-full rounded-lg border bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none  dark:bg-form-input dark:text-white dark:focus:border-primary ${
                        !errors.password && errors.password ? 'border-red-500' :  "border-stroke dark:border-form-strokedark"
                      }`}
                    />
                  </div>
                  {!errors.password && errors.confirmPassword?.message && 
                      <div className='flex items-center gap-1 mt-1'>
                      <MdOutlineError className='text-red-500'/>
                      <p className="text-red-500">{errors.confirmPassword.message}</p></div>
                  }
                </div>
                <div className="mb-5">
                  <input
